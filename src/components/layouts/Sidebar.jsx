...
//           {isAdminAndCoach && <p className="sb-section-label">Owner</p>}
//           {ADMIN_NAV.map((n) => <NavItem key={n.to} {...n} />)}
//         </div>
//       )}

//       {isAdminAndCoach && <div className="sb-divider" />}

//       {isCoach && (
//         <div className="sb-section">
//           {isAdminAndCoach && <p className="sb-section-label">Coach</p>}
//           {(isAdminAndCoach ? COACH_NAV.slice(1) : COACH_NAV).map((n) => (
//             <NavItem key={n.to} {...n} />
//           ))}
//         </div>
//       )}
